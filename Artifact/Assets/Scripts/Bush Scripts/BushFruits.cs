...
{
    [SerializeField]
    GameObject BushHarvestParticlePrefab;
    ...
    void CreateBushHarvestedParticle()
    {
        Instantiate(BushHarvestParticlePrefab, transform.position, transform.rotation);
